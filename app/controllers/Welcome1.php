...
class Welcome1 extends Controller {
	...
	public function email(){
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'capioallan091929@gmail.com';
        $mail->Password = 'abzl vcgz dmqt ilpb';
	...
	public function sendVerificationEmail($to, $verificationCode) {
		...
		$from = 'capioallan091929@gmail.com';
		$mail->setFrom($from, 'Allan');
		$mail->addAddress( $to);
		// var_dump($email);
		$mail->isHTML(true);
